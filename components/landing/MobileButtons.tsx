...
import { Lock, HelpCircle, BarChart3, Smartphone, User, Trophy } from 'lucide-react';
...
/**
 * Boutons d'action pour mobile (affichés sous le titre)
 */
    ...
    <div className="sm:hidden flex items-center gap-1.5 flex-wrap justify-center w-full mt-2 px-2">
      ...
      {statsEnabled && (
        <button
          ...
          className="hidden sm:inline-flex relative p-2.5 rounded-xl backdrop-blur-xl bg-white/5 hover:bg-white/10 active:bg-white/15 border border-white/10 hover:border-white/25 text-white/70 hover:text-white active:scale-95 transition-all duration-300 group shadow-lg hover:shadow-xl"
          style={{
          ...
          onFocus={(e: React.FocusEvent<HTMLButtonElement>) => {
            e.currentTarget.style.boxShadow = '0 8px 32px rgba(0, 0, 0, 0.3), inset 0 1px 0 rgba(255, 255, 255, 0.1), 0 0 0 3px rgba(236, 72, 153, 0.5)';
          }}
        ...
        >
          ...
          <BarChart3 className="relative w-4 h-4 group-hover:scale-110 group-active:scale-95 transition-transform duration-300" />
        </button>
      )}
      ...
      {isAdminAuthenticated && (
        ...
        >
          ...
          <div className="relative">
            ...
            <Smartphone className="relative w-4 h-4 group-hover:scale-110 group-hover:rotate-6 group-active:scale-95 group-active:rotate-0 transition-all duration-300 drop-shadow-lg" />
          </div>
        </button>
      )}
      ...
      {battleModeEnabled && (
        ...
        >
          <div className="absolute inset-0 bg-gradient-to-r from-yellow-500/0 via-orange-500/0 to-yellow-500/0 group-hover:from-yellow-500/25 group-hover:via-orange-500/25 group-hover:to-yellow-500/25 transition-all duration-500 opacity-0 group-hover:opacity-100 blur-sm" />
          <div className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-1000 bg-gradient-to-r from-transparent via-white/30 to-transparent" />
          <div className="absolute inset-0 bg-yellow-500/25 rounded-xl blur-xl opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
          <Trophy className="relative w-4 h-4 group-hover:scale-110 group-hover:rotate-3 group-active:scale-95 group-active:rotate-0 transition-all duration-300 drop-shadow-lg" />
        </button>
      )}
