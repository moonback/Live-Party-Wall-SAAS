          ...
          <div className="flex items-center gap-3">
            ...
            {currentEventName && (
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={onBack}
                className="flex items-center justify-center gap-2 px-3 py-2 rounded-lg border border-green-500/20 bg-green-500/10 hover:bg-green-500/20 transition-all duration-200 text-green-400 hover:text-green-300 group"
              ...
              >
                ...
                <span className="text-sm font-medium hidden sm:inline">Application</span>
              </motion.button>
            )}
          </div>
