...
/**
 * Page de tarification complète avec stratégie ROI
 */
const Pricing: React.FC<PricingProps> = ({ onAdminClick }) => {
      ...
      <div className="relative z-10 pt-16 sm:pt-20">
        ...
        <section id="offers" className="py-12 sm:py-16 px-4 sm:px-6 lg:px-8 bg-black/20">
          <div className="max-w-7xl mx-auto">
            ...
            {/* Subscriptions */}
            <div className="mt-16 bg-gradient-to-r from-purple-900/30 to-pink-900/30 backdrop-blur-xl rounded-2xl p-8 border border-purple-500/20">
        ...
        <section id="roi" className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8">
          <div className="max-w-5xl mx-auto">
            ...
            <div className="space-y-8">
              {/* Point 1 */}
              <div className="bg-gradient-to-r from-red-900/20 to-orange-900/20 backdrop-blur-xl rounded-2xl p-6 sm:p-8 border border-red-500/20">
              ...
              {/* Point 2 */}
              <div className="bg-gradient-to-r from-pink-900/20 to-purple-900/20 backdrop-blur-xl rounded-2xl p-6 sm:p-8 border border-pink-500/20">
                <div className="flex items-start gap-4">
              ...
              {/* Point 3 */}
              <div className="bg-gradient-to-r from-green-900/20 to-emerald-900/20 backdrop-blur-xl rounded-2xl p-6 sm:p-8 border border-green-500/20">
                <div className="flex items-start gap-4">
        ...
        <section className="py-16 sm:py-20 px-4 sm:px-6 lg:px-8 bg-black/20">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-gradient-to-r from-blue-900/20 to-purple-900/20 backdrop-blur-xl rounded-2xl p-6 sm:p-8 border border-blue-500/20 mb-8">
